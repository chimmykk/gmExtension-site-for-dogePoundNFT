        ...
        <PolicySection>
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    <strong>USAGE DATA:</strong> is data collected automatically, either generated by the use of the Service or from interactions with third-party services initiated by the Extension (e.g., logs from image servers or AI APIs containing IP addresses).
                    <br />
                    ...
                    <br />
                    <strong>DATA PROCESSORS (OR SERVICE PROVIDERS):</strong> means any natural or legal person who processes data on behalf of the Data Controller. We use third-party Service Providers (like CDN and API hosts) as detailed below.
                    <br />
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                        <strong>Handling:</strong> This data is processed transiently. The Extension does *not* store this X.com page data, *except* when specific pieces (like tweet text) are explicitly sent to a third-party service by user action (see below).
                    <br /><br />

                    <strong>3. Data Sent to Third-Party Services:</strong>
                    <br />
                    ...
                    <br />
                            <strong>Destination:</strong> This data is sent via an HTTPS POST request to an external API endpoint: <code>https://mintpad-ape-terminal.onrender.com/api/generate-doge</code>.
                    <br />
                            <strong>Service Provider:</strong> An external API hosted on Render.com.
                    <br />
                            <strong>Purpose:</strong> To generate a potentially relevant text reply or a modified Doge image based on the tweet context and your prompt, using an AI model hosted by the third-party service.
                    <br />
                            <strong><span style={{ color: 'red' }}>IMPORTANT DISCLAIMER:</span></strong> We do not operate or control the <code>mintpad-ape-terminal.onrender.com</code> service or the underlying AI model. We do not know how this third-party service stores, logs, or otherwise uses the data (tweet text, user prompt, Doge Number) sent to it. <strong>By using the "ReplyGenAI🐶" feature, you explicitly acknowledge and consent to sending this data to this external third-party service and agree that you do so at your own risk.</strong> We advise against submitting sensitive personal information through this feature.
                    <br /><br />

                    <strong>4. Usage Data:</strong>
                    <br />
                        The Extension itself does not directly collect traditional Usage Data like your browsing history. However, when the Extension makes requests to third-party Service Providers (CloudFront, Render API) on your behalf, those services will automatically collect standard technical data associated with the requests, such as your IP address, browser type/version, request timestamp, and requested resource. This collection is governed by the privacy policies of those respective Service Providers.
                    <br /><br />
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    0.4. to facilitate the generation of AI-powered replies or images via a third-party API when you choose to use the ReplyGenAI feature;
                    <br />
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br /><br />
                    <strong>Data Sent to Third Parties:</strong> We do not control the retention policies of AWS CloudFront or the <code>mintpad-ape-terminal.onrender.com</code> service. Their retention of request logs or submitted data (like prompts and tweet text for the AI feature) is governed by their respective policies.
                </TextM>
            </PolicyText>
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    <strong>Render API:</strong> Data sent via the "ReplyGenAI🐶" feature is transferred to the server hosting <code>https://mintpad-ape-terminal.onrender.com</code>, the physical location of which may be outside your jurisdiction (Render.com utilizes servers in various regions, often the US).
                    <br /><br />
                    Your consent to this Privacy Policy followed by your use of the Extension (and specifically the features involving these transfers) represents your agreement to these transfers. GmAwoo will take reasonable steps to ensure data sent *by the extension* uses secure protocols (HTTPS), but cannot guarantee the security practices of the third-party services themselves.
                </TextM>
            </PolicyText>
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    <strong>To Service Providers:</strong> We disclose necessary data to third-party Service Providers to enable the Extension's functionality:
                    <br />
                    ...
                    <br />
                        - Render API (<code>mintpad-ape-terminal.onrender.com</code>): Receives Doge Number, tweet text, and user prompts when you use the ReplyGenAI feature.
                    <br />
                    <strong>Disclosure for Law Enforcement:</strong> Under certain circumstances, we may be required to disclose information if required to do so by law or in response to valid requests by public authorities.
                    <br />
                    <strong>Business Transaction:</strong> If we are involved in a merger, acquisition or asset sale, information handled by the Extension may be transferred.
                    <br />
                    <strong>Protection of Rights:</strong> If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Extension developers, our users, or others.
                    <br />
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    The security of your data is important to us. Extension Configuration Data is stored locally using Chrome's storage mechanisms. We use HTTPS for requests made by the Extension to external APIs (CloudFront, Render API). However, remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect data interactions initiated by the Extension, we cannot guarantee absolute security, especially concerning data handled by third-party services.
                </TextM>
            </PolicyText>
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    <strong>Access, Update, Delete:</strong> For data stored locally (`DogeNumbers`, `usernameset`), you can manage this directly through the Extension's interface (input field, reset button) or by clearing the Extension's data in your browser settings / uninstalling. For data potentially held by third-party services (CloudFront logs, Render API submissions), you would need to contact those services directly, subject to their policies.
                    <br />
                    <strong>Rectification, Objection, Restriction, Portability:</strong> These rights primarily apply to Personal Data. As the Extension aims to minimize direct collection of PII, exercising these rights mainly pertains to data held by third parties as mentioned above.
                    <br />
                    ...
                    <br />
                    <strong>Contact:</strong> If you wish to inquire about data potentially held or processed directly by us (which is minimal, primarily configuration data), please contact us at <strong>{contactEmail}</strong>. We may ask you to verify your identity.
                    <br />
                    ...
                    <br />
                    <strong>CCPA "Do Not Sell":</strong> We do not sell your Personal Information for monetary value. The transfer of data to the Render API for the AI feature is necessary for its function and is performed only upon your explicit action (clicking the button and submitting the prompt), constituting consent for that specific transfer. If you wish to prevent such transfers, do not use the ReplyGenAI feature.
                </TextM>
            </PolicyText>
            ...
            <PolicyText>
                ...
                <TextM className="policy">
                    ...
                    <br />
                    - <strong>Render.com:</strong> Hosts the external API (<code>https://mintpad-ape-terminal.onrender.com</code>) used by the "ReplyGenAI🐶" feature.
                </TextM>
            </PolicyText>
            ...
            {/* Removed the old PolicyMaker attribution line */}
