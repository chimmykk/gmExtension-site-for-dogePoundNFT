...
import { Heading, PolicySection, TextM, PolicyText, PolicyHeading } from "../styles/appContainer"
    ...
    return(
      <PolicySection>
          ...
          <PolicyText>
              ...
              <TextM className="policy ">Welcome to GmAwoo. <br />
                GmAwoo (“us”, “we”, or “our”) operates https://gmgmbot.com/ (hereinafter referred to as “Service”). Our Privacy Policy governs your visit to https://gmgmbot.com/, and explains how we collect, safeguard and disclose information that results from your use of our Service. We use your data to provide and improve Service. By using Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions. Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).
              </TextM>
          </PolicyText>
          ...
          <PolicyText>
              <Heading className="policy border">Types of Data Collected</Heading>
              <TextM className="policy ">
              We collect several different types of information for various purposes to provide and improve our Service to you.
              </TextM>
          </PolicyText>
...
We use cookies and similar tracking technologies to track the activity on our Service and we hold certain information. Cookies are files with a small amount of data which may include an anonymous unique identifier. Cookies are sent to your browser from a website and stored on your device. Other tracking technologies are also used such as beacons, tags and scripts to collect and track information and to improve and analyze our Service. You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our Service. Examples of Cookies we use:
          ...
          <PolicyText>
              ...
              <TextM className="policy ">
              GmAwoo uses the collected data for various purposes:
<br />
...
<br />
0.13. for any other purpose with your consent.              </TextM>
          </PolicyText>

          <PolicyText>
              <Heading className="policy border">Retention of Data</Heading>
              <TextM className="policy ">
              We will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies. We will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer time periods.              </TextM>
          </PolicyText>

          <PolicyText>
              <Heading className="policy border">Transfer of Data</Heading>
              <TextM className="policy ">
              Your information, including Personal Data, may be transferred to – and maintained on – computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction. If you are located outside United State and choose to provide information to us, please note that we transfer the data, including Personal Data, to United State and process it there. Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer. GmAwoo will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.               </TextM>
          </PolicyText>
...
<br />
0.3.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.              </TextM>
<br />
          </PolicyText>
          ...
          <PolicyText>
              <Heading className="policy border">Your Data Protection Rights Under General Data Protection Regulation (GDPR)</Heading>
              <TextM className="policy ">
              If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR. We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data. If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at team@rarityranks.io. In certain circumstances, you have the following data protection rights:
<br />
...
<br />
          ...
          <PolicyText>
              <Heading className="policy border">Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</Heading>
              <TextM className="policy ">
...
<br />
0.4. users are able to change their personal information by emailing us at team@rarityranks.io.
<br />
...
We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked. You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.
          ...
          <PolicyText>
              <Heading className="policy border">Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</Heading>
              <TextM className="policy ">
...
If you submit a request to stop selling your personal information, we will stop making such transfers. Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights. To exercise your California data protection rights described above, please send your request(s) by email: team@rarityranks.io. Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.
          ...
          <PolicyText>
              <Heading className="policy border">Analytics</Heading>
              <TextM className="policy ">
          ...
          <PolicyText>
              <Heading className="policy border">CI/CD tools</Heading>
              <TextM className="policy ">
          ...
          <PolicyText>
              <Heading className="policy border">Behavioral Remarketing</Heading>
              <TextM className="policy ">
          ...
          <PolicyText>
              <Heading className="policy border">Payments</Heading>
              <TextM className="policy ">
          ...
          <PolicyText>
              <Heading className="policy border">Links to Other Sites</Heading>
              <TextM className="policy ">
          ...
          <PolicyText>
              ...
              <TextM className="policy ">
              If you have any questions about this Privacy Policy, please contact us by email: team@rarityranks.io.
              </TextM>
          </PolicyText>
